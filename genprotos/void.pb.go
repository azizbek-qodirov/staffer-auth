...
var file_staffer_protos_void_proto_goTypes = []interface{}{
...
func file_staffer_protos_void_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_staffer_protos_void_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Void); i {
			case 0:
				return &v.state
			case 1:
		...
		file_staffer_protos_void_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Byid); i {
			case 0:
				return &v.state
			case 1:
		...
		file_staffer_protos_void_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
