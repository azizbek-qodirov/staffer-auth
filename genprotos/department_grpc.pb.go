...
func (c *departmentServiceClient) Create(ctx context.Context, in *DepartmentCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/staff.DepartmentService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *departmentServiceClient) GetByID(ctx context.Context, in *Byid, opts ...grpc.CallOption) (*DepartmentGetResUpdateReq, error) {
	...
	err := c.cc.Invoke(ctx, "/staff.DepartmentService/GetByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *departmentServiceClient) Update(ctx context.Context, in *DepartmentGetResUpdateReq, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/staff.DepartmentService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *departmentServiceClient) Delete(ctx context.Context, in *Byid, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/staff.DepartmentService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *departmentServiceClient) GetAll(ctx context.Context, in *DepartmentGetAllReq, opts ...grpc.CallOption) (*DepartmentGetAllRes, error) {
	...
	err := c.cc.Invoke(ctx, "/staff.DepartmentService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DepartmentService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/staff.DepartmentService/Create",
	}
...
func _DepartmentService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/staff.DepartmentService/GetByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DepartmentService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/staff.DepartmentService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DepartmentService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/staff.DepartmentService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DepartmentService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/staff.DepartmentService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
